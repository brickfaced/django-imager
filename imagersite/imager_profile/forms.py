...
class ProfileEditForm(ModelForm):
    ...
    class Meta:
        model = ImagerProfile
        fields = ['bio', 'phone', 'location', 'website', 'fee', 'is_active', 'camera', 'services', 'photostyles']
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['street'].initial = ImagerProfile.objects.get(user__username=username).street